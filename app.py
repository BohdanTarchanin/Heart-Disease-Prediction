...
selection = st.sidebar.radio("Choose a Functionality", ["Heart Disease Dataset Analysis", "Heart Disease Prediction"])

if selection == "Heart Disease Dataset Analysis":
    ...
    model_choice = st.selectbox("Choose a Machine Learning Model", ["Support Vector Machines", "K-Nearest Neighbors", "Decision Trees", "Random Forest", "XGBoost", "Neural Networks", "Comparison of the Machine Learning Models"])
    ...
    if model_choice == "Support Vector Machines":
        # SVM model code
        ...
        st.write(f"AUC-ROC: {roc_auc_score(y_test, y_proba):.2f}")
